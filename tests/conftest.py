...
@pytest.fixture(scope='module')
async def database(gino_placeholder, get_statuses_by_request_id, get_payload_by_request_id):
...
@pytest.fixture
def mock_app(mock_msg, event_loop, cache, request_cache, database, mocker):
